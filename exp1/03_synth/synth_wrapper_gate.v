...
// Generated on: May 24 2025 12:42:02
...
module synth_wrapper(X, Y, rst_n, clk, S, Cin, Co);
  ...
  sky130_fd_sc_hd__dfrtp_1 \S_reg[2] (.RESET_B (rst_n), .CLK (clk), .D
       (n_32), .Q (S[2]));
  sky130_fd_sc_hd__o21ai_2 g2388(.A1 (n_15), .A2 (n_30), .B1 (n_9), .Y
       (n_33));
  sky130_fd_sc_hd__xnor2_1 g2389(.A (n_16), .B (n_0), .Y (n_32));
  sky130_fd_sc_hd__o2bb2ai_1 g2390(.A1_N (n_66), .A2_N (n_29), .B1
       (n_66), .B2 (n_29), .Y (n_31));
  ...
  sky130_fd_sc_hd__dfrtp_1 \S_reg[0] (.RESET_B (rst_n), .CLK (clk), .D
       (n_23), .Q (S[0]));
  sky130_fd_sc_hd__nand2_2 g2397(.A (n_21), .B (n_24), .Y (n_27));
  ...
  sky130_fd_sc_hd__inv_1 g2419(.A (X_reg[1]), .Y (n_6));
  ...
  sky130_fd_sc_hd__inv_2 g2425(.A (X_reg[0]), .Y (n_4));
  sky130_fd_sc_hd__buf_2 g2426(.A (X_reg[0]), .X (n_3));
  sky130_fd_sc_hd__inv_2 g2427(.A (Cin_reg), .Y (n_2));
  sky130_fd_sc_hd__buf_1 g2428(.A (Cin_reg), .X (n_1));
